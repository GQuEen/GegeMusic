...
- (void)scrollViewDidScroll:(UIScrollView *)scrollView {
    ...
    if (_currentBtnIndex != self.currentSelectBtn.tag) {
        ...
        [UIView animateWithDuration:0.1 animations:^{
            _underLine.frame = CGRectMake(weakSelf.currentSelectBtn.frame.origin.x, weakSelf.underLine.frame.origin.y, weakSelf.underLine.frame.size.width, weakSelf.underLine.frame.size.height);
        } completion:nil];
    }
